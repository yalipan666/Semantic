function cfg = el_Start_offw(cfg)
...
%try
    ...
    window_el=Screen('OpenOffscreenwindow', cfg.screenNumber);
    ...
    cfg.el.defaults = EyelinkInitDefaults(window_el);
